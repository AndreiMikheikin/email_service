...
function requireReactJsxRuntime_production_min() {
  ...
  var f = require$$0, k = Symbol.for("react.element"), l2 = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, n = f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, p = { key: true, ref: true, __self: true, __source: true };
  function q(c, a, g) {
...
function requireReactDomServerLegacy_node_production_min() {
  ...
  var ea = require$$0, fa = require$$1, n = Object.prototype.hasOwnProperty, ha = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, ia = {}, ja = {};
  function ka(a) {
    if (n.call(ja, a))
      return true;
    if (n.call(ia, a))
...
function requireReactDomServer_node_production_min() {
  ...
  var aa = require$$0$1, ba = require$$0, k = null, l2 = 0, q = true;
  function r(a, b) {
    if ("string" === typeof b) {
      if (0 !== b.length)
        if (2048 < 3 * b.length)
...
const handleError$1 = (error) => {
  var _a, _b;
  const serverMessage = (_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message;
  const message = serverMessage || error.message || "Неизвестная ошибка";
  throw new Error(message);
};
const registerUser = async ({ email, password }) => {
  try {
    const response = await apiClient$1.post("/api/users/register", { email, password });
...
const resendConfirmationEmail = async (data) => {
  try {
    const response = await apiClient$1.post("/api/users/resend-confirmation", data);
    return response.data;
  } catch (error) {
    return handleError$1(error);
  }
...
const loginUser = async ({ email, password }) => {
  try {
    const response = await apiClient$1.post("/api/users/login", { email, password });
    return response.data;
  } catch (error) {
    return handleError$1(error);
  }
...
const forgotPassword = async ({ email }) => {
  try {
    const response = await apiClient$1.post("/api/users/forgot-password", { email });
    return response.data;
  } catch (error) {
    return handleError$1(error);
  }
...
const resetPassword = async ({ token, password }) => {
  try {
    const response = await apiClient$1.post("/api/users/reset-password", { token, password });
    return response.data;
  } catch (error) {
    return handleError$1(error);
  }
...
const changePassword = async ({ email, oldPassword, newPassword }) => {
  try {
    const response = await apiClient$1.post("/api/users/change-password", {
      email,
      oldPassword,
      newPassword
    });
...
const fetchAdminDashboard = async () => {
  try {
    const response = await apiClient$1.get("/api/adminDashboard");
    return response.data;
  } catch (error) {
    return handleError$1(error);
  }
};
apiClient$1.interceptors.request.use((config) => {
...
const Login = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aam_login-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "aam_login-form", onSubmit: handleSubmit, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "aam_login-title", children: "Вход" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "aam_login-button", type: "submit", disabled: loading, children: loading ? "Вход..." : "Войти" }),
    message && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aam_login-message", children: message }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_login-links", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/forgot-password", children: "Забыли пароль?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/reset-password", children: "Сброс пароля" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/register", children: "Нет аккаунта? Регистрация" })
    ] })
  ] }) });
};
...
const isFormValid = (email, password, passwordConfirm, passwordChecks) => {
  return email && password && passwordConfirm && Object.values(passwordChecks).every(Boolean);
};
const _register = "";
const Register = () => {
  const [email, setEmail] = useState("");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage(((_b = (_a = err.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message) || "Ошибка регистрации");
    }
    setLoading(false);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aam_register-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "aam_register-form", onSubmit: handleSubmit, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "aam_register-title", children: "Регистрация" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_password-checks", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Пароль должен содержать:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: passwordChecks.length ? "valid" : "", children: "Минимум 8 символов" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: passwordChecks.lowercase ? "valid" : "", children: "Строчную букву" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: passwordChecks.uppercase ? "valid" : "", children: "Прописную букву" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: passwordChecks.number ? "valid" : "", children: "Цифру" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: passwordChecks.match ? "valid" : "", children: "Совпадение паролей" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
    ...
    message && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aam_register-message", children: message }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aam_register-links", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", children: "Уже есть аккаунт? Войти" }) })
  ] }) });
};
const _emailConfirm = "";
const EmailConfirm = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_email-confirm-container", children: [
    status === "loading" && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aam_email-confirm-message loading", children: "Подтверждение..." }),
    status === "success" && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "aam_email-confirm-message success", children: [
      "Почта успешно подтверждена! Перенаправляем на вход через ",
      countdown,
      "..."
    ] }),
    status === "error" && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "aam_email-confirm-message error", children: [
      "Ошибка: ",
      errorMessage
    ] }),
    status === "expired" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_email-confirm-message expired", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Ссылка подтверждения истекла. Введите email для повторной отправки письма:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "email",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleResend, children: "Отправить повторно" })
    ] })
  ] });
};
...
const ForgotPassword = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aam_forgot-container", children: status === "success" ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aam_forgot-message success", children: "Если адрес существует в базе, мы отправим вам ссылку для сброса пароля." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "aam_forgot-form", onSubmit: handleSubmit, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Восстановление пароля" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type: "email",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: status === "loading", children: status === "loading" ? "Отправка..." : "Отправить ссылку" }),
    status === "error" && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aam_forgot-message error", children: errorMessage }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", children: "Отмена" })
  ] }) });
};
...
const ResetPassword = () => {
  ...
  const isFormValidReset = () => {
    if (token) {
      ...
      return email && currentPassword && Object.values(passwordChecks).every(Boolean);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(((_b = (_a = err.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message) || "Ошибка при изменении пароля");
    }
    setLoading(false);
  };
  if (token && tokenError) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_reset-password-container", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aam_error", children: "Ссылка для сброса пароля недействительна или устарела." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", children: "На главную" })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aam_reset-password-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "aam_reset-password-form", onSubmit: handleSubmit, noValidate: true, children: [
    token ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      "Электронная почта: ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: emailFromToken || "..." })
    ...
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aam_error", children: error }),
    message && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aam_success", children: message }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: !formValid || loading, children: loading ? token ? "Сброс пароля..." : "Изменение пароля..." : token ? "Сбросить пароль" : "Изменить пароль" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", children: "Отмена" })
  ] }) });
};
const _adminDashboard = "";
const API_URL = "http://178.250.247.67:3355";
...
const createPoolUser = async ({ email, password }) => {
  try {
...
const updatePoolUserPassword = async (id, password) => {
  try {
...
const ClientUsersBox = ({ onAddClick, onEditClick, reloadFlag }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "aam_box", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "aam_box__title", children: "Пользователи клиента" }),
    Array.isArray(users) && users.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "aam_box__list", children: users.map((user) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "li",
      {
      ...
      user.id
    )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aam_box__list-empty", children: "Нет доступных пользователей." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_box__actions", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "aam_box__button", onClick: onAddClick, children: "Добавить пользователя" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
...
const AddClientUserModal = ({ isOpen, onClose, onUserAdded }) => {
  ...
  if (!isOpen)
    return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aam_modal-overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_modal", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "aam_modal__close", onClick: onClose, children: "×" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "aam_modal__title", children: "Добавить пользователя" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "aam_box__form", onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "email",
    ...
    message && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aam_box__message", children: message })
  ] }) });
};
const EditClientUserModal = ({ user, onClose, onUserUpdated }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aam_modal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_modal__content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Редактировать пользователя" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_modal__actions", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleUpdate, disabled: loading || !password, children: "Обновить пароль" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleDelete, disabled: loading, className: "danger", children: "Удалить пользователя" })
    ] }),
    message && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aam_modal__message", children: message }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, className: "aam_modal__close", children: "×" })
  ] }) });
};
...
const createEmailTemplate = async ({ name, subject, body }) => {
  try {
...
const updateEmailTemplate = async (id, { name, subject, body }) => {
  try {
...
const EmailTemplatesBox = ({ onAddClick, onEditClick, reloadFlag }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "aam_box", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "aam_box__title", children: "Шаблоны писем" }),
    Array.isArray(templates) && templates.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "aam_box__list", children: templates.map((tpl) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "li",
      {
      ...
      tpl.id
    )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aam_box__list-empty", children: "Нет доступных шаблонов." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_box__actions", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "aam_box__button", onClick: onAddClick, children: "Добавить шаблон" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          className: "aam_box__button",
...
const AddTemplateModal = ({ isOpen, onClose, onTemplateAdded }) => {
  ...
  if (!isOpen)
    return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aam_modal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_modal__content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Добавить шаблон письма" }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aam_modal__error", children: error }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type: "text",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_modal__actions", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "aam_modal__button", onClick: handleSubmit, children: "Сохранить" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "aam_modal__button", onClick: onClose, children: "Отмена" })
    ] })
  ] }) });
};
const EditTemplateModal = ({
  ...
  const [body, setBody] = useState((template == null ? void 0 : template.body) || "");
  const [error, setError] = useState("");
  useEffect(() => {
    if (template) {
  ...
  if (!isOpen || !template)
    return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aam_modal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_modal__content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Редактировать шаблон" }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aam_modal__error", children: error }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_modal__actions", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "aam_modal__button", onClick: handleUpdate, children: "Сохранить" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "aam_modal__button", onClick: handleDelete, children: "Удалить" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "aam_modal__button", onClick: onClose, children: "Отмена" })
    ] })
  ] }) });
};
const AdminDashboard = () => {
  ...
  const handleOpenEditModal = (user2) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "aam_dashboard_header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_dashboard_header-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "aam_dashboard_title", children: message }),
      user && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_dashboard_user-info", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "Email: ",
          user.email
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "aam_dashboard_main", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_dashboard_preview-grid", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ClientUsersBox,
        {
    ...
    isEditModalOpen && selectedUser && /* @__PURE__ */ jsxRuntimeExports.jsx(
      EditClientUserModal,
      {
        user: selectedUser,
    ...
    isAddTemplateModalOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      AddTemplateModal,
      {
    ...
    isEditTemplateModalOpen && selectedTemplate && /* @__PURE__ */ jsxRuntimeExports.jsx(
      EditTemplateModal,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "aam_dashboard_footer", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "aam_dashboard_footer-link", children: "Телеграм канал" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "aam_dashboard_footer-copy", children: "Все права защищены" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aam_dashboard_footer-contacts", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:", className: "aam_dashboard_footer-contact", children: "мой адрес" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:", className: "aam_dashboard_footer-contact", children: "мой телефон" })
      ] })
    ] })
  ] });
};
